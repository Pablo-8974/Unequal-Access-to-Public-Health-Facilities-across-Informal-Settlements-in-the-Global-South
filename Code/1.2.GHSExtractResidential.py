...
def residential_loop():
    total_file_dir = r"C:\Users\k\Desktop\slum\paper\Nature-2\data\GHS-built\Total"
    NRES_file_dir = r"C:\Users\k\Desktop\slum\paper\Nature-2\data\GHS-built\non-residential"
    save_dir = r'C:\Users\k\Desktop\slum\paper\Nature-2\data\GHS-built\residential'
    ...
    for total_file_path in total_file_list:
        ...
        NRES_file_path = os.path.join(NRES_file_dir, total_file_name.replace('total', 'NRES'))
        save_path = os.path.join(save_dir, total_file_name.replace('total', 'RES'))
